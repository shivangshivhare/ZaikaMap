            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <h2 className="text-2xl font-bold font-mono bg-gradient-to-r from-orange-500 to-red-500 text-transparent bg-clip-text mb-4">
                            Zoto
                        </h2>
                        <p className="text-gray-400 mb-6 max-w-md">
                            Discover the best restaurants near you with our AI-powered recommendation engine. Your perfect dining experience is just a click away.
                        </p>
